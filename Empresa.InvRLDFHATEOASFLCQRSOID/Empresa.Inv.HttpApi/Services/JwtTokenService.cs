...
public class JwtTokenService
{
    ...
    {
        //var privateKeyPem = File.ReadAllText(_jwtSettings.PrivateKey);
        //var publicKeyPem = File.ReadAllText(_jwtSettings.PublicKey);

        var privateKeyPem =  _jwtSettings.PrivateKey ;
